...
//Clear/new grid container attached to main container
...
const runEtch = e => {
    ...
    newDiv.forEach(div => div.addEventListener('mouseover', blackEtch));         //randomColor function added to every div
}
...
const clearColorGrid = e => {
    ...
    newDiv.forEach(div => div.addEventListener('mouseover', randomColor));      //randomColor function added to every div
}
...
const clearFadeGrid = e => {
    ...
    newDivs.forEach(div => div.addEventListener('mouseover', fadeToBlack));    //fadeToBlack function added to every div
}
...
const regularGrid = e => {
    ...
    for (const div of containers) {
        ...
        newDiv.forEach(div => div.addEventListener('mouseover', blackEtch));   //Turns Etch-A-Sketch divs black
}
...
const colorReset = e => {
    r = 255;                                                                  //Resets rgb color to white
    g = 250;                  
    b = 250;
}
